...
For example, he can say he wants to start tracking its nutrition, specifying the metrics he want to find in the habit (e.g. calorie intake and protein grams); then, withing the same recording process, he can also ask to log the habits for the day, which are "Running" and "Water Drunk", telling he ran 10 km in one and a half hour, and that he drank 8 glasses of water.
...
% TODO place here updated images (screenshot) for each main app page
    ...
    "user-id-123456": {
      "habits": [
        ...
        },
        {
          ...
          "history": [
            {
              "timestamp": "2025-03-26T15:30",
              "metrics": {
                "Calorie intake": 2200
              }
            },
            {
              "timestamp": "2025-03-21T19:30",
              "metrics": {
                "Calorie intake": 1900
              }
            },
            {
              "timestamp": "2025-03-21T13:30",
              "metrics": {
                "Calorie intake": 2100
              }
            }
...
\begin{minted}[fontsize=\small, linenos, breaklines]{json}
{
  "creation": [
    {
      "habit-name": "Running",
      "habit-description": "Go for a run in your free time",
      "habit-goal": "I want to run 3 times a week in order to train for PolimiRun",
      "metrics": [
        {
          "metric-name": "Distance",
          "metric-description": "Kilometers run",
          "input": "Slider",
          "config": {
            "type": "int",
            "min": 0,
    ...
    {
      "habit-name": "Food",
      "habit-description": "Log the food you eat",
      "habit-goal": "I want to eat max 2000 kcal per day",
      "metrics": [
        {
          "metric-name": "Calorie intake",
          "metric-description": "How many calories did this food have?",
          "input": "Slider",
          "config": {
            "type": "int",
            "min": 0,
  ...
  "logging": [
    ...
    {
      "timestamp": "2025-03-24T17:30",
      "habit-name": "Mediation",
      "metrics": {
        "Duration": "00:30:00",
        "Satisfaction": "3-stars",
        "Notes": "I felt really good afterwards"
      }
    }
  ]
}
