...
\begin{minted}[fontsize=\tiny, linenos, breaklines]{json}
{
  "creation": [
    {
      "name": "Running",
...
\begin{minted}[fontsize=\tiny, linenos, breaklines]{json}
{
  "users": {
    "user-id-123456": {
      "name": "Kello",
      "description": "I like going to the gym, and I'd like to hit 100 kg on bench press one day",
      "habits": {
        "Running": {
          "description": "Go for a run in your free time",
          "goal": "I want to run 3 times a week in order to train for PolimiRun",
